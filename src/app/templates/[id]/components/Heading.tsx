    ...
    return (
        <div className="w-full h-[68px] flex justify-between items-center py-[12px] px-[24px]">
            <div className="flex items-center">
                <NavButton callBack={()=>goBack()} component="back" icon="back"/>
                <span className="font-NeueMachinaBold text-[24px] leading-[32px] text-heading-text-lite dark:text-heading-text-dark mr-[4px]">Название документа</span>
